    ...
    <form class="container container-form">
      <div class="form-group">
        <div class="input-container">
          <input class="montserrat-s16 montserrat-s16-n400 input" type="text" placeholder="Full name*" required>
        </div>
        <div class="input-container">
          <input class="montserrat-s16 montserrat-s16-n400 input" type="tel" placeholder="Your phone">
        </div>
      </div>
      <div class="input-container">
        <input class="montserrat-s16 montserrat-s16-n400 input" type="email" placeholder="Your email*" required>
      </div>
      <div class="input-container">
        <label class="montserrat-s16 montserrat-s16-n400">What are you interested in* <span class="montserrat-s16 montserrat-s16-n300">Multi-select</span></label>
        <div>
          <label v-for="o in data.offers" :key="o" :for="o" class="label label-form">
            <input :id="o" :name="o" type="checkbox">{{ o }}
          </label>
        </div>
      </div>
      <div class="input-container">
        <label class="montserrat-s16 montserrat-s16-n400">Estimated budget <span class="montserrat-s16 montserrat-s16-n300">Optional</span></label>
        <div>
          <label v-for="b in data.priceRanges" :key="b" :for="b" class="label label-form">
            <input :id="b" name="budget" type="radio">{{ b }}
          </label>
        </div>
      </div>
      <div class="input-container">
        <textarea class="montserrat-s16 montserrat-s16-n400 input" placeholder="Project description*" required></textarea>
      </div>
      <div class="input-container">
