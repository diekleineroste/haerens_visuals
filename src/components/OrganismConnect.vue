    ...
    <form class="container container-form">
      <div class="form-group">
        <div class="input-container">
          <input class="montserrat-s16 montserrat-s16-n500 input" type="text" placeholder="Full name*" required>
        </div>
        <div class="input-container">
          <input class="montserrat-s16 montserrat-s16-n500 input" type="tel" placeholder="Your phone">
        </div>
      </div>
      <div class="input-container">
        <input class="montserrat-s16 montserrat-s16-n500 input" type="email" placeholder="Your email*" required>
      </div>
      <div class="input-container">
      ...
      <div class="input-container">
        <textarea class="montserrat-s16 montserrat-s16-n500 input" placeholder="Project description*" rows="5" required></textarea>
      </div>
      <div class="input-container">
